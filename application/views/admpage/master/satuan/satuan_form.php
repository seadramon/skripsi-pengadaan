...
<!--                        <h3 class="box-title">Quick Example</h3>-->
                    ...
                    <form id="kategori" name="kategori" action="{action}" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="group">Tipe</label>
                                <?php echo form_dropdown('id_tipe', $tipe, array_key_exists('id_tipe', $post[0])?$post[0]['id_tipe']:"", 'class="form-control" id="id_tipe"'); ?>
                            </div>
                            <div class="form-group">
                                <label for="group">Deskripsi</label>
                                <textarea class="form-control" name="deskripsi" placeholder="Deskripsi">{deskripsi}</textarea>
                            </div>
                            {/post}
                        </div><!-- /.box-body -->
