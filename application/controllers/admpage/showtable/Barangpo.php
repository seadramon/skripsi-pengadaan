...
class Barangpo extends CI_Controller
{
	...
	public function index($idAttr = "",$idpo = "")
	{
		$this->main($idAttr, $idpo);
	}

	function main($idAttr = "",$idpo = "")
	{
        ...
        $total_records = 0;
        if ($idpo!="") {
            $query = $this->detailpo_model->getAll($idpo);
            ...
            $this->session->set_flashdata('info_msg', 'Data Kosong karena ID PO belum dipilih');
        }
        ...
        $this->parser->parse($template.'barangpo', $data);
	}
}
?>