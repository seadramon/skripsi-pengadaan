    ...
    <section class="content">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Laporan Order Pembelian Barang</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">List Order Pembelian Barang</h3>
                    </div><!-- /.box-header -->
                    ...
                    <form id="form-{file_app}" name="form-{file_app}" action="<?php echo $actionCetak ?>" method="post" >
                        ...
                        ?>
                            <div class="box-footer clearfix">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo base_url() ?>admpage/laporan/test/cetak/<?php echo $start.'/'.$end ?>" 
