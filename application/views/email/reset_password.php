                        ...
                        <table class="row note">
                            <tr>
                                <td class="wrapper last">
                                    <p>
                                        Kepada Yth Bpk/Ibu <?=$name?>
                                    </p>
                                    <p>
                                        Silahkan klik link di bawah untuk me-reset password anda
                                    </p>
                                    <!-- BEGIN: Note Panel -->
                                        ...
                                        <tr>
                                            <td class="wrapper">
                                                <table class="six columns">
                                                    <tr>
                                                        <td class="vertical-middle">
                                                            &copy; PT. Jayadata Indonesia 2014
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
