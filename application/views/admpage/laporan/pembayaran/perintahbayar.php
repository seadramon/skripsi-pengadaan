            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Laporan Perintah Bayar</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                        ...
                        ?>
                            <div class="box-footer clearfix">
                                ...
                                <div class="pull-right">
                                    ...
                                    <a href="<?php echo base_url() ?>admpage/laporan/perintahbayar/cetak/<?php echo $start.'/'.$end.'/'.$statusVal ?>" 
