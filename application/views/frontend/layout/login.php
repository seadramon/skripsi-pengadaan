...
<!--    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css" rel="stylesheet" type="text/css" />-->
    ...
    <!-- iCheck -->
    <link href="<?=assets_folder('admin')?>plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?=site_url()?>"><b>Bantuin</b>Login</a>
    </div><!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <?php if ($error_login != '') : ?>
            <div class="alert alert-danger alert-dismissable">
                <button class="close" data-close="alert" data-dismiss="alert" aria-hidden="true">x</button>
			<span>
			<?= $error_login ?> </span>
            </div>
        <?php endif; ?>
...
<!-- iCheck -->
<script src="<?=assets_folder('admin')?>plugins/iCheck/icheck.min.js" type="text/javascript"></script>
<script>
    $(function () {
        $('input').iCheck({
