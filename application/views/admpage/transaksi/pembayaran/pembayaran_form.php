    ...
    <section class="content">
                    ...
                    <form id="fpembayaran" name="fpembayaran" action="{action}" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="button" onClick='targetitem = document.fpembayaran.idpo; 
     ...
     "dataitem","width=600,height=400,scrollbars=yes"); dataitem.targetitem = targetitem' value="Cari PO">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date-picker" readonly data-date-format="yyyy-mm-dd" name="tanggal_perintahbayar" id="tanggal_perintahbayar" value="{tanggal_perintahbayar}">
                            </div>
                            <div class="form-group">
                                <label for="name">Jumlah Bayar</label>
                                <input type="number" class="form-control" name="jml_bayar" id="jml_bayar" value="{jml_bayar}">
                            </div>
                            <div class="form-group">
